...
interactionIds <- c(47, 48, 56, 57)

metric <- "rmse"
titles <- c(
  "**A.** Non-linearity: Moderate, AUC: 0.65",
  "**B.** Non-linearity: Moderate, AUC: 0.85",
  "**C.** Non-linearity: High, AUC: 0.65",
  "**D.** Non-linearity: High, AUC: 0.85"
)
...
pp <- gridExtra::grid.arrange(
  ...
  ggplot2::ggsave(
    file.path("figures", "rmse_nl_auc.tiff"), 
    plot = pp,
    width = 8.5, 
    height = 7,
    compression = "lzw"
  ...
  ggplot2::ggsave(
    file.path("figures", "rmse_nl_auc.png"), 
    plot = pp,
    width = 8.5, 
    height = 7
  )
